...
export class GameL3 extends GameScene
{
    ...
    create (data)
    {
        ...
        enemiesObjectLayer.forEach((enemyObj) => {
            const enemy = this.enemiesGroup.create(enemyObj.x * 3, enemyObj.y * 3, 'enemy');  // Adjust for scale and origin
            enemy.setOrigin(0, 1);  // Object layers use top-left as origin
            enemy.setScale(3);  // Match tile scale
