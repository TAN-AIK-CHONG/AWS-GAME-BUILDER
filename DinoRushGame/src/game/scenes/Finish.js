...
export class Finish extends Scene
{
    ...
    handleSubmit(playerName) {
        ...
        const scoreData = {
            name: playerName,
            time: parseInt(this.elapsedTime)
        };
        ...
        fetch('http://localhost:3000/submit', {
            ...
            .then(message => {
                ...
                this.add.text(512, 450, 'Score submitted!', {
                    fontSize: '24px',
                    fill: '#fff'
                }).setOrigin(0.5);
            })
            .catch(error => {
                ...
                this.add.text(512, 100, 'Failed to submit score!', {
                    fontSize: '24px',
                    fill: '#f00'
                }).setOrigin(0.5);
            });
    ...
    removeInputElements() {
        // Clean up input elements when leaving scene
